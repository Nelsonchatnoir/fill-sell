...
function UpgradeModal({ lang, slotsRemaining, onClose, onCheckout }) {
  ...
  const PREM_F = lang==='en'
    ? ['Unlimited stock','🎙️ AI voice · 20 commands/day','📸 Lens Pro · 10/day · live market price','Advanced AI-powered stats','Import / Export Excel','Priority support']
    : ['Stock illimité','🎙️ IA vocale · 20 commandes/jour','📸 Lens Pro · 10/jour · prix marché en direct','Stats avancées analysées par IA','Import / Export Excel','Support prioritaire'];
  return (
