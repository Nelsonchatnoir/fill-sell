export const translations = {
  fr: {
    ...
    urgenceArticles:"⚠️ Plus que {n} article{s} — passe Premium →",
    debloquer:"Passer Premium →",
    ...
    stepPublishAddToStockHintAlways:"Chaque publication ajoute l'article à ton inventaire.",
    stepPublishBuyPriceLabel:"Combien tu l'as payé ?",
    stepPublishBuyPricePlaceholder:"0 si tu ne l'as pas payé",
    stepPublishBuyPriceRequired:"Indique le prix d'achat — mets 0 si tu ne l'as pas payé.",
    stepPublishInventoryFull:"Ton inventaire est plein : 20 articles en gratuit. Passe Premium pour un stock illimité et continuer à publier.",
  ...
  en: {
    ...
    stepPublishAddToStockHintAlways:"Every listing adds the item to your inventory.",
    stepPublishBuyPriceLabel:"How much did you pay for it?",
    stepPublishBuyPricePlaceholder:"0 if you didn't pay for it",
    stepPublishBuyPriceRequired:"Enter the purchase price — use 0 if you didn't pay for it.",
    stepPublishInventoryFull:"Your inventory is full: 20 items on the free plan. Go Premium for unlimited stock and keep publishing.",
