export const translations = {
  fr: {
    ...
    cardCustomField:"Modifié à part",
    cardResetToGeneral:"Rétablir",
    cardConditionBetter:"Cette plateforme n'a pas cet état exact — c'est le plus proche, et il est plus flatteur que le réel. Vérifie-le.",
    cardAdjustedTitle:"Titre raccourci pour tenir dans la limite de cette plateforme.",
    cardAdjustedDescription:"Description raccourcie pour tenir dans la limite de cette plateforme.",
    cardAdjustedSymbols:"Suites de symboles réduites : cette plateforme les refuse.",
    cardAdjustedLbcMentions:"Leboncoin refuse toute mention d'un autre site : elles seront retirées au dépôt.",
    cardAdjustedLbcHashtags:"Leboncoin n'accepte que 5 mots-clés : les suivants seront retirés au dépôt.",
  ...
  en: {
    ...
    cardCustomField:"Set apart",
    cardResetToGeneral:"Reset",
    cardConditionBetter:"This platform has no exact match — this is the closest one, and it flatters the item. Double-check it.",
    cardAdjustedTitle:"Title shortened to fit this platform’s limit.",
    cardAdjustedDescription:"Description shortened to fit this platform’s limit.",
    cardAdjustedSymbols:"Runs of symbols reduced: this platform rejects them.",
    cardAdjustedLbcMentions:"Leboncoin rejects any mention of another site: they will be removed at posting time.",
    cardAdjustedLbcHashtags:"Leboncoin only allows 5 keywords: the rest will be removed at posting time.",
...
export const landingTranslations = {
  fr: {
    ...
    feature5Desc: "Importe tes articles en masse et exporte ton historique en un clic pour ta comptabilité.",
    ...
    pricingProFeatures: ["Stats avancées","Export Excel","Import en masse","Support prioritaire"],
  ...
  en: {
    ...
    feature5Title: "Import & Export Excel",
    feature5Desc: "Import your items in bulk and export your full history in one click for accounting.",
    ...
    pricingProFeatures: ["Advanced stats","Excel export","Bulk import","Priority support"],
