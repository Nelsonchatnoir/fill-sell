export const translations = {
  fr: {
    ...
    stepPublishInventoryFull:"Ton inventaire est plein : {n} articles en gratuit. Passe Premium pour un stock illimité et continuer à publier.",
  ...
  en: {
    ...
    stepPublishInventoryFull:"Your inventory is full: {n} items on the free plan. Go Premium for unlimited stock and keep publishing.",
