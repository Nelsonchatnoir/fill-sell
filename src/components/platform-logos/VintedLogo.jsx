// Tracé officiel Vinted — source: simple-icons (npm, CC0), hex de marque #007782.
export default function VintedLogo({ size = 14 }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} xmlns="http://www.w3.org/2000/svg" fill="#007782">
      <title>Vinted</title>
