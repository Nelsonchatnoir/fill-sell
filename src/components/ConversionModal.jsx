...
const T = {
  ...
  proCoinsLabel: { fr: '600 Pépites incluses chaque mois', en: '600 Nuggets included every month' },
  proCoinsSub:   { fr: '≈ 17 annonces en retouche avancée / mois', en: '≈ 17 listings with advanced retouching / mo' },
