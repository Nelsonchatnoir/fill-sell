  ...
  return(
    <div style={{position:"fixed",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"linear-gradient(135deg,#3EACA0,#E8956D)",padding:"24px",boxSizing:"border-box"}}>
      <div style={{width:"100%",maxWidth:420,textAlign:"center"}}>
        ...
        <div style={{fontSize:16,color:"rgba(255,255,255,0.85)",marginBottom:12,lineHeight:1.6}}>Ton abonnement est actif. Tu peux ajouter des articles en illimité, profiter de l'IA vocale et des stats avancées.</div>
