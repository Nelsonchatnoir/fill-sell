...
const T = {
  fr: {
    ...
    premiumF7: '📸 Lens Pro · 10/jour · 120/mois · prix marché en direct',
    lens_badge: 'NOUVEAU',
    lens_title: 'Lens',
    ...
    pricing_premium_lens: '📸 Lens Pro · 10/jour · 120/mois · prix marché en direct',
    ...
    premiumF2: 'Stock illimité', premiumF3: '🎙️ IA vocale · Illimité',
  ...
  en: {
    ...
    premiumF7: '📸 Lens Pro · 10/day · 120/month · live market price',
    lens_badge: 'NEW',
    lens_title: 'Lens',
    ...
    pricing_premium_lens: '📸 Lens Pro · 10/day · 120/mo · live market price',
    ...
    premiumF2: 'Unlimited stock', premiumF3: '🎙️ AI voice · Unlimited',
...
const FAQ_ITEMS = {
  ...
  en: [
    ...
    { q: 'How does the Lens feature work?', a: 'Take up to 5 photos of your item directly from the app. The AI identifies the brand, model, size and condition, then gives you a resale price range based on the current market — with the best platforms and a concrete tip. Free plan: 3 analyses/day · 15/month (visual estimate only). Premium: 10/day · 120/month with live market prices.' },
    ...
    { q: 'Is FillSell free?', a: 'Yes, the free plan is permanent. It includes up to 20 items, 5 voice commands/day, 3 Lens analyses/day · 15/month and all stats. The Premium plan at €9.99/month unlocks unlimited items, unlimited voice, Lens Pro with live market prices, Excel export and advanced stats.' },
        ...
        <div className="lp-container">
          ...
          <div className="pricing-grid">
            ...
            <div className="price-card premium reveal delay-1">
              ...
              <div className="price-amount"><span className="num">{slotsRemaining !== null && slotsRemaining > 0 ? '9,99 €' : '14,99 €'}</span><span className="per">{t.premiumPer}</span></div>
              ...
              {slotsRemaining !== null && slotsRemaining > 0 && (
                <div style={{ fontSize: 12, fontWeight: 700, color: '#92400E', background: 'rgba(251,191,36,0.12)', border: '1px solid rgba(251,191,36,0.4)', borderRadius: 8, padding: '6px 14px', textAlign: 'center', marginBottom: 6 }}>
                  {lang === 'fr' ? 'Ensuite 14,99 €/mois pour les nouveaux abonnés' : 'Then €14.99/month for new subscribers'}
                </div>
              )}
              <ul className="price-features">
