...
| D4 | **Beebs : annonces qui disparaissent** | Deux dépôts confirmés (2026-07-11) ont disparu des deux onglets sans notification. **Cause inconnue.** Un job partirait en `published` pour une annonce qui n'existe pas. À élucider avant de compter sur Beebs en prod. |
