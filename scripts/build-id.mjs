...
export const EXTENSION_LAST_COMMIT = '2026-09-24T09:45:53Z'; // recale 3bacdee (bump manifeste 0.6.65 : la sonde Opla ne rend plus jamais `false` sur un 401 — quinze comptes retenus/affichés « Autoriser Opla » à tort le 24/09 — et le popup ne montre « Autoriser Opla » qu'à un poste sans l'accès). UTC VRAI lu par EPOCH. Posée dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD et PUBLISHED_BUILD_IDS NON touchés : le zip 0.6.65 n'est pas encore accepté par le CWS.
