...
export const EXTENSION_LAST_COMMIT = '2026-09-16T15:23:17Z'; // recale 880ffd9 (catalogue Opla : arbre serveur + niveau qui a echoue - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). MIN_BUILD et PUBLISHED_BUILD_IDS NON touches : aucun paquet n'est parti. Ancienne valeur : 2026-09-16T07:41:43Z, recalait c1958cb (opla.co REMIS apres l'empaquetage de la 0.6.40 - dernier commit touchant chrome-extension/) - UTC VRAI lu par EPOCH (%ct -> toISOString), jamais la date locale de git log. Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD et PUBLISHED_BUILD_IDS NON touches : la 0.6.40 n'est pas televersee.
