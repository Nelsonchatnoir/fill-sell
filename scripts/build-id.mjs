...
// 2026-08-04T18:00:00Z = sync du dressing commandable à distance (background :
// `version` envoyée au poll + traiterCommandeSyncDistante).
export const EXTENSION_LAST_COMMIT = '2026-08-04T18:00:00Z';
