...
export const EXTENSION_LAST_COMMIT = '2026-09-24T12:22:41Z'; // recale 5422734 (0.6.65 reconstruite : Vinted « neuf seulement » dit comme une limite + relevé d'options propre + retrait d'une annonce d'une autre boutique reconnu ; Leboncoin transporteurs/format/poids posés d'après la page réelle, relus, bilan livraison_lbc ; capture shipping_type values). UTC VRAI lu par EPOCH. Posée dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD et PUBLISHED_BUILD_IDS NON touchés : le zip 0.6.65 n'est pas encore accepté par le CWS.
