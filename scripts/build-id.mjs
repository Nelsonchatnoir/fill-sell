...
export const EXTENSION_LAST_COMMIT = '2026-09-23T22:48:12Z'; // recale sur 16b0199, le bump manifeste 0.6.63 du lot « zero regression » (dernier commit touchant chrome-extension/ : taille EU nu->EU N, releve hub eBay tolerant + reprise technique, message Opla unique + AUTORISER_OPLA, captures perimees 20/run). UTC VRAI lu par EPOCH. Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD et PUBLISHED_BUILD_IDS NON touches : le zip 0.6.63 n'est pas encore accepte par le CWS, aucune extension du parc n'est flaggee obsolete. EXTENSION_MIN_BUILD sera promu APRES acceptation CWS (geste de Nico).
