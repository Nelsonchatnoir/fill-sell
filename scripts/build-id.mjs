...
// 2026-09-07T18:40:00Z : BEEBS rejoint les autres. Sa RECHERCHE de categorie
// (relevee sur la vraie page ce soir : tolerante aux accents et aux pluriels)
// devient une source de candidats, et l'IA tranche parmi ce que Beebs propose.
// Les LISTES FERMEES (etat, taille, couleur...) sont lues SUR LA PAGE et
...
export const EXTENSION_LAST_COMMIT = '2026-09-20T15:30:33Z'; // recale cf7b8dc (passe 3 : le code mort d'Opla retire - oplaEstFacultatif et OPLA_SEL.parLibelle n'ont jamais ete appeles, Opla poste sur une API - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.48 n'est ni empaquetee ni televersee. Ancienne valeur : 2026-09-20T15:22:55Z'; // recale 244c3cf (passe 3 : un champ ISBN absent saute l'etape au lieu d'arreter la republication, et le delai reel de confirmation des photos est enfin consigne sur les REUSSITES - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.48 n'est ni empaquetee ni televersee. Ancienne valeur : 2026-09-20T15:02:04Z'; // recale 404316f (passe 2, point 3 : le catalogue Opla apprend - categoryKeyOf lit enfin oplaCategoryCode/Path, et opla.js releve { sizes, colors, materials } depuis /public/config/params, qu'il chargeait deja - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.48 n'est ni empaquetee ni televersee - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-20T13:47:37Z'; // recale 740941b (BLOC 3 : la contamination PRO fermee dans background.js - LBC_CHAMPS_PRO_SEULEMENT + requisSansContaminationPro aux deux points d'ecriture du catalogue - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.48 n'est pas encore empaquetee ni televersee - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-20T13:36:32Z'; // recale 0472382 (0.6.48 : ISBN illisible non bloquant, transporteurs Leboncoin, dressing au-dela de la page 1, boucle Opla - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.48 est empaquetee mais PAS televersee - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-20T07:21:58Z'; // recale 980b3a1 (Vinted : le classement par age s'appelle video_game_ratings, au PLURIEL - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : AUCUN paquet n'est prepare (consigne de Nico, la 0.6.47 vient d'etre servie) - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-19T18:50:15Z, // recale a3d49f9 (capture Leboncoin : ad.attributes gardé ENTIER + URL retrouvée par l'identifiant CERTAIN du dépôt, jamais par le titre seul ; bump manifest 0.6.47 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.47 est empaquetee mais PAS televersee, et la 0.6.46 est encore en examen - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-19T12:06:39Z, recale 1516f39 (prix Leboncoin en CENTIMES : 1800 = 18 EUR, attrape avant toute ecriture - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.46 n'est PAS empaquetee - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-19T11:59:12Z, recale 8c24d27 (Leboncoin lu par l'adresse - dashboard/v1/search, offset honore, list_id et url rendus, le defilement passe en repli - ET le releve des VENTES Vinted/Leboncoin/Opla - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.46 n'est PAS empaquetee (ordre de Nico) - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-19T11:04:29Z, recale b118b3b (veilleur Leboncoin : « Article vendu » lu sur l'annonce VIVANTE, forme rendue et ancree avant le h1 ; une vente n'entre plus dans les URL mortes - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.46 n'est PAS empaquetee (ordre de Nico) - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-19T10:55:13Z, recale e358ff2 (sync dressing : « repris » veut dire qu'on a deja lu quelque chose - le bouton distant adoptait la ligne qu'il venait de creer, 84 faux sauts de marquage sur 88 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.46 n'est PAS empaquetee (ordre de Nico) - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-19T09:57:17Z, recale 352683f (retrait Beebs par l'identifiant exact, le titre en repli - dernier commit touchant chrome-extension/, posé a 11h57 sans bump, ce qui cassait `npm run build`). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.46 n'est PAS empaquetee (ordre de Nico) - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-19T09:30:03Z, recale 10fe7bb (releve eBay : pagination par l'adresse - ?limit=200&offset=N, compteur « annonces en cours » lu, verdict de couverture, borne 15 pages ; bump manifest 0.6.46 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.46 n'est PAS empaquetee (ordre de Nico : d'autres correctifs s'ajoutent aujourd'hui, le paquet partira d'un seul coup) - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-18T22:18:24Z, recale eed8eaa (bump manifest 0.6.45). // recale eed8eaa (bump manifest 0.6.45 : lot Leboncoin « Mes annonces » - garde de couverture 29f896c (le releve ne conclut plus disparues des annonces EN LIGNE : il lit « En ligne (N) » et se marque incomplet s'il en voit moins) + defilement patient ddec502 (la page a un defilement infini, le plafond de 30 etait celui de NOTRE boucle) - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.44 est EN EXAMEN au Store et la 0.6.45 n'est pas televersee - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-18T20:16:05Z, recale b747e9f (bump manifest 0.6.44 : lot Leboncoin « depot sans identifiant » 1625aec + les trois correctifs du panneau de categories Vinted - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.43 est EN EXAMEN au Store et la 0.6.44 n'est pas televersee - la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-18T18:01:07Z, recale 07494c6 (categorie Vinted : le clic sur une suggestion fermait le panneau, plus personne ne le rouvrait - trois correctifs, dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : la 0.6.43 est EN EXAMEN au Store, ces correctifs partiront en 0.6.44. Ancienne valeur : 2026-09-18T16:35:31Z, recale le correctif vinted (403 anti-robot -> reprise espacee, et delai du premier niveau du panneau de categories) - dernier commit touchant chrome-extension/. UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : le paquet 0.6.43 est REFAIT mais toujours pas televerse. Ancienne valeur : 2026-09-18T14:24:00Z, recale le bump manifest 0.6.43 (dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : le paquet 0.6.43 est produit mais PAS ENCORE televerse - la banniere « extension obsolete » ne bouge pas d'un pixel tant que le CWS ne l'a pas accepte. Ancienne valeur : 2026-09-18T14:03:24Z, recale be14a73 (releve : la VALEUR et jamais le texte d'aide - lecture par feuille, garde a l'ecriture, vocabulaire sans-marque eBay - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.43 pas encore televerse, la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-18T11:36:28Z, recale 38d1d70 (popup : « Autoriser Opla » toujours atteignable tant que l'acces manque - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.43 pas encore televerse. Ancienne valeur : 2026-09-18T10:36:12Z, 407c2b4 (releve : statut 'absente' au lieu de 'failed' quand la plateforme n'est pas la - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.43 pas encore televerse, la banniere « extension obsolete » ne bouge pas d'un pixel. Ancienne valeur : 2026-09-18T07:50:25Z, 2584cd4 (Opla : descente automatique tant qu'un seul chemin est plausible, et la question part avec sa liste (oplaCategoryAsk), 0.6.42 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.42 pas encore televerse. Ancienne valeur : 2026-09-17T22:25:24Z, recalait 137df4c (vues/favoris par plateforme au relevé, prix illisible NULL, vignette Opla, 0.6.42 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.42 pas encore televerse. Ancienne valeur : 2026-09-17T22:17:01Z, recale ca00d08 (capture : taille/marque Leboncoin par libellé, article rattaché complété, images Opla CloudFront, 0.6.42 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.42 pas encore televerse. Ancienne valeur : 2026-09-17T21:28:07Z, recale 6c8f257 (relevé : titres/prix par feuille + capture complète ; Opla catégorie acquise + descente par le mot ; Stock bloc unique, 0.6.42 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.42 pas encore televerse. Ancienne valeur : 2026-09-17T20:10:06Z, recale 6bafafa (retrait Leboncoin : confirmation par MODALE, page /suppression disparue, 0.6.42 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.42 pas encore televerse. Ancienne valeur : 2026-09-17T19:20:18Z, recalait 4628ad4 (relevé multiplateforme + taille Vinted W32 L34, 0.6.42 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.42 pas encore televerse. Ancienne valeur : 2026-09-17T18:14:41Z, recalait d0f9617 (republication multiplateforme Leboncoin/Beebs, retrait partagé, 0.6.42 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.42 pas encore televerse. Ancienne valeur : 2026-09-17T13:26:41Z, recalait c49ff2c (port de remplissage keepalive lots 1-3, 0.6.42 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString). Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD NON touche : paquet 0.6.42 pas encore televerse. Ancienne valeur : 2026-09-17T12:20:00Z, recalait 2081298 (bump manifest 0.6.42 : borne fetch AbortController sur vinted/leboncoin/beebs/ebay + couche 2 priorite 'deleted' bornee N=3 - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString), jamais la date locale de git log. Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD et PUBLISHED_BUILD_IDS NON touches : le paquet 0.6.42 n'est pas encore televerse, la banniere « extension obsolete » ne bouge pas. Ancienne valeur : 2026-09-16T22:03:53Z, recalait 689a4ae (opla.co en permission d'hote OPTIONNELLE, 0.6.41 : manifest, background, popup, opla.js - dernier commit touchant chrome-extension/). UTC VRAI lu par EPOCH (%ct -> toISOString), jamais la date locale de git log. Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD et PUBLISHED_BUILD_IDS NON touches : le paquet 0.6.41 n'est pas encore televerse, la banniere « extension obsolete » ne bouge pas. Ancienne valeur : 2026-09-16T17:51:52Z, recalait e30b62b (leboncoin pro). // recale e30b62b (leboncoin pro : le releve nommait « Choisissez » - dernier commit touchant chrome-extension/, pose par l'autre terminal SANS bump, ce qui cassait `npm run build` partout, Codemagic compris). UTC VRAI lu par EPOCH (%ct -> toISOString), jamais la date locale de git log. Posee dans un commit qui ne touche PAS chrome-extension/. MIN_BUILD et PUBLISHED_BUILD_IDS NON touches : aucun paquet n'est parti, la banniere « extension obsolete » ne bouge donc pas d'un pixel. Ancienne valeur : 2026-09-16T15:23:17Z, recalait 880ffd9 (catalogue Opla).
...
export const PUBLISHED_BUILD_IDS = {
  ...
  // 0.6.44 et 0.6.45 : inscrites le 19/09, RELEVÉES EN BASE et non déclarées —
  // 10 comptes en extension_version='0.6.44' (build '2026-09-18T20:16:32Z+43c05ec')
  // et 15 comptes en '0.6.45' (build '2026-09-18T22:19:14Z+713d53f'), vus dans
  // l'heure. Les deux sont donc SERVIES par le Chrome Web Store. Sans cette
  // inscription, rien n'empêchait un re-empaquetage de ces numéros, que le Store
