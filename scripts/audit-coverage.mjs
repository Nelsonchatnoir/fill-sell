...
const battery = [
  ...
  // objet du mot-clé, pour verrouiller les deux sens. ────────────────────
  ["Dyson Airwrap Soft Smoothing Brush Attachment Noir/Magenta", "Accessoire de brosse lissante souple pour Dyson Airwrap multi-styler. Soies à pointe douce pour un soin optimal des cheveux.", "💇"],
  ["Embout brosse lissante pour Airwrap", "💇"],
  ["Lisseur GHD Platinum+", "💇"],
  ["Sèche-cheveux Dyson Supersonic", "💇"],
  ["Coffret soin du visage", "🧴"],
  ["Medik8 Crystal Retinal", "Soin de la peau anti-âge, texture crème.", "🧴"],
  ["Statuette artisanale peinte", "Une large palette de couleurs chaudes.", "📦"],
  ["Palette de maquillage Naked Urban Decay", "💄"],
  ["JBL Flip 5 étanche", "Top qualité sonore, enceinte puissante et compacte.", "🔊"],
  ["Top dentelle noir taille S", "👕"],
  ["Volkswagen Polo 1.2 TSI 90ch", "Voiture citadine essence, 5 portes.", "🚗"],
  ["Polo Ralph Lauren manches courtes", "👕"],
  ["Console d'entrée bois massif", "📦"],
  ["Console PS5 édition digitale", "🎮"],
  ["Switch réseau TP-Link 8 ports", "📦"],
  ["Nintendo Switch OLED blanche", "🎮"],
  ["Batterie lithium rechargeable 18650", "📦"],
  ["Batterie Pearl Export complète", "🥁"],
  ["Carte micro SD SanDisk 128 Go", "📦"],
  ["Micro Shure SM58", "🎤"],
  ["Kit pinceaux de maquillage 12 pièces", "💄"],
  ["Pinceau plat spécial lasure", "🖌️"],
  ["Cadre de vélo carbone taille 54", "🚲"],
  ["Cadre photo bois 30x40", "🖼️"],
  ["Peluche souris grise Jellycat", "🧸"],
  ["Souris Logitech MX Master 3", "🖱️"],
  ["Corde ondulatoire training", "Atteignez vos objectifs fitness et gagnez en masse musculaire.", "🏋️"],
  ["Masse de chantier 5 kg", "🔨"],
  ["Porte-manteau mural en bois", "📦"],
  ["Manteau laine camel", "🧥"],
  ["Maquette Ferrari F40 échelle 1:18", "📦"],
  ["Échelle télescopique 3m80", "🪜"],
  ["Bougies d'allumage NGK x4", "📦"],
  ["Bougie parfumée vanille", "🕯️"],
  ["Poêle à bois en fonte 8 kW", "📦"],
  ["Poêle antiadhésive 28 cm", "🍳"],
  ["Parure de lit 240x260 coton", "🛌"],
  ["Parure de bijoux plaqué or", "💍"],
  ["Coffret cadeau ambiance romantique", "📦"],
  ["Roman policier édition poche", "📚"],
  ["Piano de cuisson Smeg 90 cm", "📦"],
  ["Piano numérique Yamaha P-45", "🎹"],
  ["Coussin de grossesse", "Idéal pour femme enceinte et allaitement.", "📦"],
  ["Enceinte Bluetooth JBL Charge 5", "🔊"],
  ["Stickers vinyle déco murale", "📦"],
  ["Vinyle Pink Floyd 33 tours", "💿"],
  ["Protection verre trempé universelle", "📦"],
